    ...
    for(int iType=0; iType<nRuns; iType++) {
        ...
        for(int i = 0; i < 5; i++){
            ...
            for(int iPtBin=0;iPtBin<10;iPtBin++) {
                ...
                hImaginaryPart[iType][i][iPtBin] = new TH1D(Form("hImaginaryPartT%02iH%02iPtB%02i",iType,i+1,iPtBin),Form("hImaginaryPartT%s%02i %.1f - %.1f",sType[iType].Data(),i+1,ptBins[iPtBin],ptBins[iPtBin+1]),400,-10.0,20.0); hImaginaryPart[iType][i][iPtBin]->Sumw2();
            }
